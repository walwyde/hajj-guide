...
//     const hajjDua = {
//       transliteration: "Allāhumma innī urīdu al-ḥajja fayasirhu lī wataqabbalhu minni.",
// translation : "O Allah, I intend to perform Hajj, so make it easy for me and accept it from me.",
// arabicText: "اللَّهُمَّ إِنِّي أُرِيدُ الحَجَّ فَيَسِّرْهُ لِي وَتَقَبَّلْهُ مِنِّي"
//     }
...
const Dashboard = () => {
  ...
  const hajjDua = {
    transliteration: "Allāhumma innī urīdu al-ḥajja fayasirhu lī wataqabbalhu minni.",
    translation: "O Allah, I intend to perform Hajj, so make it easy for me and accept it from me.",
    arabicText: "اللَّهُمَّ إِنِّي أُرِيدُ الحَجَّ فَيَسِّرْهُ لِي وَتَقَبَّلْهُ مِنِّي"
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          {/* Hajj Intention Dua */}
          <Card className="max-w-2xl mx-auto mb-8 bg-gradient-to-br from-card to-accent/5">
            <CardHeader>
              <CardTitle className="text-xl text-accent flex items-center justify-center gap-2">
                <BookOpen className="w-5 h-5" />
                Hajj Intention Dua (Niyyah)
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              {/* Animated Content */}
              <AnimatedCanvasText
                text={`Transliteration: ${hajjDua.transliteration}\n\nTranslation: "${hajjDua.translation}"`}
                speed={30}
                className="my-4"
              />
            </CardContent>
