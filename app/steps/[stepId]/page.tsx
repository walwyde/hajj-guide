...
// DuaPlayer Component
// function DuaPlayer({ audioText, title }: { audioText: string; title: string }) {
...
//   useEffect(() => {
//     const audioElement = new Audio(`/${audioText}.mp3`)
            ...
            <Card className="border-card-border hover:border-accent/30 transition-colors bg-gradient-to-br from-card to-green-500/5 border-green-200">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-secondary/20 p-4 rounded-lg">
                  ...
                  <DuaPlayer clientId="" sourceUrl={step.dua.audioSource} title={step.title} />
                </div>
